...
const NAV: NavItem[] = [
  ...
  {
    href: "/machines/stock",
    label: "Stock & Reorder Matrix",
    icon: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z",
  },
  {
    href: "/machines/tba",
    label: "TBA Reservations",
    icon: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z",
  },
  {
    href: "/machines/admin",
    label: "Manage Lookups & Stock",
...
export function MachinesSidebar({
  isAdmin = false,
  isOpen = false,
  onClose,
    ...
    <div className="flex flex-col h-full bg-slate-900 text-slate-200">
      ...
      <div className="p-4 border-b border-slate-800 flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h2 className="text-sm font-bold text-white tracking-tight leading-tight">Machine Monitoring</h2>
            <p className="text-[10px] text-blue-400 font-medium">Inventory · Stock · TBA</p>
          </div>
        </div>
